...
def dispatch_action(client: DolphinSchedulerClient, action: str, payload: Dict[str, Any]) -> Tuple[bool, Any]:
    handlers = {
        ...
        "batch_update_schedule_alerts": lambda: client.batch_update_schedule_alerts(payload),
        ...
        "check_failed_instances": lambda: client.check_failed_instances(payload),
        ...
        "update_workflow_environment": lambda: client.update_workflow_environment(payload),
        "batch_update_workflow_environment": lambda: client.batch_update_workflow_environment(payload),
